...
export class HelloPage implements OnInit {
  ...
  items = [
   ...
   funs = [
    {img: './assets/icon/brain-in-head.svg', text: 'เพลงฝึกสามธิสำหรับผู้เริ่มต้นผ่อนคลายง่าย เข้าถึงสมาธิ'},
    {img: './assets/icon/sleepy.svg', text: 'คลิปวิดีโอโยคฝึกสมาธิง่ายๆ สำรหับผู้เริ่มต้น'},
   ];
